...
public class StudentManage implements Manage<Student> {
    ...
    public void writeClassroom (){
        File f = new File("C:\\Modul2\\AQuan\\Btvn\\minitest_25\\src\\studen.txt");
        try {
            if(!f.exists()){
    ...
    public void readClassroom() throws IOException {
        ...
        while ((c=bufferedReader.readLine())!=null){
            str= c.split(", ");
            students.add(new Student(str[1],Integer.parseInt(str[2]),str[3],Double.parseDouble(str[4]),new Classroom(str[5])));
        }
